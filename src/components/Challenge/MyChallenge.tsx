...
//   const [selectedSort, setSelectedSort] = useState("Premier League");
  ...
  const handleJoinLounge = async () => {
    ...
    return     <div className="flex flex-col gap-4 bg-inherit md:bg-white md:dark:bg-[#121212] rounded p-0 md:p-4 h-[86vh] overflow-y-auto scrollbar-hide pb-6 md:pb-4">
