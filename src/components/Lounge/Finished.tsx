    ...
    return (
        <div className="flex flex-col items-center w-full">
            ...
            >
                ...
                >
                    <span className="text-[13px] text-[#3A3D46] dark:text-[#C9CDD4]">Goal Scorers</span>
                    <IoChevronDown
                        size={16}
            ...
            >
                <button
                    className="flex justify-between items-center w-full cursor-pointer"
                >
                    <span className="text-[13px] text-[#3A3D46] dark:text-[#C9CDD4]">Substitutions</span>
                    <IoChevronDown
                        size={16}
                        className={`text-[#3A3D46] transform transition-transform duration-200`}
                    />
            ...
            >
                <button
                    className="flex justify-between items-center w-full cursor-pointer"
                >
                    <span className="text-[13px] text-[#3A3D46] dark:text-[#C9CDD4]">Red/Yellow Cards</span>
                    <IoChevronDown
                        size={16}
                        className={`text-[#3A3D46] transform transition-transform duration-200`}
                    />
            ...
            >
                <button
                    className="flex justify-between items-center w-full cursor-pointer"
                >
                    <span className="text-[13px] text-[#3A3D46] dark:text-[#C9CDD4]">Man of the Match</span>
                    <IoChevronDown
                        size={16}
                        className={`text-[#3A3D46] transform transition-transform duration-200`}
                    />
