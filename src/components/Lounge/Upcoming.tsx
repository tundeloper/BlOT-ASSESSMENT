        ...
        <div className="bg-white rounded flex flex-col w-full dark:bg-[#121212] transition-colors duration-300">
            ...
            <div className="flex flex-col gap-2.5 pb-4">
                {fixtures.map((day, dayIndex) => (
                    <div
                        key={day.date}
                        className={`flex flex-col gap-2.5 px-4 ${dayIndex !== fixtures.length - 1 ? 'pb-2.5 border-b border-[#D9D9D9]' : ''
                            }`}
                    >
                        <button
                        ...
                        >
                            ...
                            <IoChevronDown
                                size={16}
                                className={`text-[#3A3D46] transform transition-transform duration-200 ${activeDay === day.date ? 'rotate-180' : ''
                                    }`}
                            />
                        </button>
