    ...
    return (
        <div className='flex flex-col gap-4 bg-inherit md:bg-white md:dark:bg-[#121212] rounded p-0 md:p-4 h-[86vh] overflow-y-auto scrollbar-hide pb-6 md:pb-4'>
                        ...
                        <div className="relative">
                            {showDropdown && (
                                <div className="absolute right-0 mt-2 w-[145px] bg-white dark:bg-[#23262F] rounded shadow-lg border border-[#F0F0F0] dark:border-[#23262F] z-50">
                                    {['All Matches', 'Upcoming today', 'This week', 'Competitions'].map((option) => (
                                        <button
                                            key={option}
            ...
            <div className='flex flex-col gap-4 mt-4'>
                ...
                <Rules />
                <Badges />
                <p className='text-[13px] font-normal text-[#3A3D46] dark:text-white text-center'>
                    You’ll be notified instantly once you hit a badge milestone through an in-app pop-up, glow animation on your profile pic, and a badge upgrade toast. Your new badge level becomes visible across the site automatically.
                </p>
            </div>
        </div>
    )
