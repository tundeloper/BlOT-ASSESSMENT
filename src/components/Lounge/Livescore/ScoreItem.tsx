        ...
        <div className="border border-[#D9D9D9] dark:border-[#3A3D46] rounded p-4 flex flex-col gap-7 w-[45%] grow">
            <div className="flex justify-between items-start">
                <div className="flex flex-col gap-0.5">
                    <span className="text-[13px] font-medium text-[#3A3D46] dark:text-white">
                        {'Week 14'}
                    </span>
                    <span className="text-[13px] font-normal text-[#7A7F8C] dark:text-white">
                        {livescore?.date}
                    </span>
                </div>
            ...
            <div className="flex justify-between items-center">
                <div className="w-[47px] h-[43px] md:w-[70px] md:h-[70px] rounded-full overflow-hidden">
                    <Image
                ...
                <div className="flex flex-col items-center gap-2">
                    <span className="text-[20px] font-semibold text-[#1E1E1E] dark:text-white text-center">
                    ...
                    <span className="text-[10px] font-normal text-[#3A3D46] dark:text-white text-center">
