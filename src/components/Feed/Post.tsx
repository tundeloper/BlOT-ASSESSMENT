...
const Post = ({
  ...
  const handleRepost = async () => {
    ...
    if (res.success) {
      ...
      enqueueSnackbar(
        typeof res.data === "string" ? res.data : "Failed to repost",
        { variant: "error" }
      );
      setIsReposting(false);
    }
      ...
      <div className="flex flex-col gap-4">
          ...
          <div className="flex items-center gap-1">
            ...
            <div className="flex flex-col">
              ...
              <div className="flex items-center gap-2">
                <span className="text-[10px] text-[#3A3D46] dark:text-white">
                  @{post?.username}
                </span>
                <span className="text-[8px] text-[#3A3D46] dark:text-white">
        ...
        <div className="px-4">
          <div className="max-w-[341px]">
            <p className="text-[13px] text-[#3A3D46] dark:text-white">
              {post?.content}
            </p>
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-2.5">
              ...
              <div className="relative">
                ...
                {isRepostModalOpen && (
                  <ClickAwayListener
                    onClickAway={() => setIsRepostModalOpen(false)}
                  >
        ...
        <div className="px-4">
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              <div
                className={`flex flex-col gap-2 w-full rounded bg-[#E4E6EC] dark:bg-[#1A1C20] px-3 ${
                  isCommentFocused ? "py-3" : "py-1"
                }`}
              >
                  ...
                  <div className="flex justify-between w-full items-center">
                    ...
                    <button onClick={handleComment} className="cursor-pointer">
                      {isCommenting ? (
                        <CircularProgress
                          size={20}
                          sx={{ color: theme === "dark" ? "#fff" : "#3A3D46" }}
                        />
                      ) : (
                        <AiOutlineSend
                          size={20}
