...
const Header: React.FC<{ onSidebarOpen: () => void }> = ({ onSidebarOpen }) => {
  return (
    <header className="bg-white h-[72px] px-4 md:px-8 flex items-center justify-between">
      <div className="flex items-center gap-4">
        <GiHamburgerMenu color='#3A3D46' onClick={onSidebarOpen} className='cursor-pointer w-6 h-6 md:w-8 md:h-8' />
      ...
      <div className="flex items-center gap-2 md:gap-6">
        <div className="flex items-center">
          <div className="relative">
            <input
              ...
              className="hidden md:block w-[282px] h-[36px] px-4 py-1 border border-[#F9FAFB] rounded-[4px] text-sm placeholder-[#7A7F8C] focus:outline-none focus:border-blue-500"
            />
        ...
        <div className="relative p-1 cursor-pointer">
          <BiMessageDetail size={24} className="text-[#3A3D46]" />
        </div>

        <div className="relative p-1 cursor-pointer">
          <IoMdNotificationsOutline size={24} className="text-[#3A3D46]" />
        ...
        <div className="p-1 cursor-pointer hidden md:block">
          <IoSettingsOutline size={24} className="text-[#3A3D46]" />
        </div>
