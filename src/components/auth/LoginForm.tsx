        ...
        <div className="max-w-[500px] w-full md:bg-white rounded flex flex-col items-center gap-8 p-8 md:shadow-card">
            ...
            >
                ...
                <div className="flex flex-col gap-2 relative">
                    ...
                    <div
                        className={`flex items-center gap-2 border rounded px-4 w-full h-[50px] ${errors.password ? "border-red-500" : "border-[#E4E6EC]"
                            }`}
                    >
                        <input
                            id="password"
                ...
                <div className="flex justify-end">
                    <Link
                        ...
                        className="text-[13px] text-[#3A3D46] hover:text-[#2D439B] font-switzer underline"
                    >
                        Forgot Password?
                    </Link>
                </div>
